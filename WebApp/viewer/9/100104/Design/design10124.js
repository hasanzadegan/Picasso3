...
$rootScope.design_10124 = function($scope,param,$event){
	...
	// http://172.16.201.42:7001/ehealth-ws-1.2/rest/api/v1/workplace/toggle/'+$scope._workplace[index].id+'
	url= $rootScope.BaseUrls[0]+'workplace/toggle/'+$scope._workplace[index].id+'';
