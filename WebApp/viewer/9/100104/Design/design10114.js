...
$rootScope.design_10114 = function($scope,param,$event){
	...
	// http://172.16.201.42:7001/ehealth-ws-1.2/rest/api/v1/validate/sms/account/doctor/toggle?id='+$scope.DocInfo.id+'
	url= $rootScope.BaseUrls[0]+'validate/sms/account/doctor/toggle?id='+$scope.DocInfo.id+'';
