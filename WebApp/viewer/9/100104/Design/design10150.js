...
$rootScope.design_10150 = function($scope,param,$event){
	...
	// http://172.16.201.42:7001/ehealth-ws-1.2/rest/api/v1/account/signout/patient/'+$scope.patientId+'
	url= $rootScope.BaseUrls[0]+'account/signout/patient/'+$scope.patientId+'';
