app = angular.module("APP").controller("Ctrl190476", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272325 = function(param){ 
	 $rootScope.design_20196($scope,param); 
} 
