app = angular.module("APP").controller("Ctrl190550", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272340 = function(param){ 
	 $rootScope.design_10101($scope,param); 
} 

$scope.makeDesign_293382 = function(param){ 
	 $rootScope.design_20238($scope,param); 
} 
