app = angular.module("APP").controller("Ctrl190517", [
...
$scope.makeDesign_282665 = function(param){ 
	 $rootScope.design_10137($scope,param); 
} 

$scope.makeDesign_282635 = function(param){ 
