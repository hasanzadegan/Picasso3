app = angular.module("APP").controller("Ctrl190566", [
...
$scope.makeDesign_282776 = function(param){ 
	 $rootScope.design_10156($scope,param); 
} 

$scope.makeDesign_282775 = function(param){ 
