app = angular.module("APP").controller("Ctrl190651", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293239 = function(param){ 
	 $rootScope.design_20225($scope,param); 
} 
