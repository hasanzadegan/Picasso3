app = angular.module("APP").controller("Ctrl190578", function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$timeout,$http){
...
$scope.makeDesign_282910 = function(param){ 
	 $rootScope.design_10176($scope,param); 
} 
