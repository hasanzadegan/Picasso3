app = angular.module("APP").controller("Ctrl190514", [
...
$scope.makeDesign_282622 = function(param){ 
	 $rootScope.design_10130($scope,param); 
} 

$scope.makeDesign_282623 = function(param){ 
	 $rootScope.design_10131($scope,param); 
} 
