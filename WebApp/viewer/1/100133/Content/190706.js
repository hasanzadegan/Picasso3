app = angular.module("APP").controller("Ctrl190706", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303887 = function(param){ 
	 $rootScope.design_30283($scope,param); 
} 
