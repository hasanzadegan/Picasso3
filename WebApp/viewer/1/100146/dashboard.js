...
app.controller("dashboardCTRL", function ($rootScope,$scope, $http,$q, $filter,$translate){
	...
	$rootScope.dashboardParam["mainDashboard"]={"skin":"skinAdl","barColor":"#fff","searchPageContentId":"","sideNavPageContentId":"190687","pages":[]}
;
	...
	{"pageId":180503,"pageContentId":190821}
];
	...
	if(viewerSplit.length>1)
	{
        ...
        if (localStorage.getItem("__localStorage.__dashboard") != null &&
            localStorage.getItem("__localStorage.__panel") != null) {
            $rootScope.loadDashboard(localStorage.getItem("__localStorage.__dashboard"),
                localStorage.getItem("__localStorage.__panel"));
	}
	else
