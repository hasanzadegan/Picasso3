app = angular.module("APP").controller("Ctrl190599", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_292977 = function(param){ 
	 $rootScope.design_20187($scope,param); 
} 
