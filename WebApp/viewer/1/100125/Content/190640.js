app = angular.module("APP").controller("Ctrl190640", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293161 = function(param){ 
	 $rootScope.design_20220($scope,param); 
} 
