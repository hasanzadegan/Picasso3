app = angular.module("APP").controller("Ctrl190638", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293163 = function(param){ 
	 $rootScope.design_20219($scope,param); 
} 
