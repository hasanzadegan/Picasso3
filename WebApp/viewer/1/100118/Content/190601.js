app = angular.module("APP").controller("Ctrl190601", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_292982 = function(param){ 
	 $rootScope.design_20188($scope,param); 
} 

$scope.makeDesign_292988 = function(param){ 
	 $rootScope.design_20188($scope,param); 
} 
...
app.requires.push('ngMaterial','ngStorage','oc.lazyLoad','pascalprecht.translate','ngMessages','angular-material-persian-datepicker','ngMask');
