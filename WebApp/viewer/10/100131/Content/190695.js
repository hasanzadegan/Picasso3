app = angular.module("APP").controller("Ctrl190695", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303703 = function(param){ 
	 $rootScope.design_30269($scope,param); 
} 
