app = angular.module("APP").controller("Ctrl190689", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303610 = function(param){ 
	 $rootScope.design_30260($scope,param); 
} 

$scope.makeDesign_303609 = function(param){ 
	 $rootScope.design_30265($scope,param); 
} 

$scope.makeDesign_303684 = function(param){ 
	 $rootScope.design_30266($scope,param); 
} 

$scope.makeDesign_304074 = function(param){ 
	 $rootScope.design_30301($scope,param); 
} 
