app = angular.module("APP").controller("Ctrl190672", function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$timeout,$http){
...
$scope.makeDesign_293460 = function(param){ 
	 $rootScope.design_20245($scope,param); 
} 
