app = angular.module("APP").controller("Ctrl190698", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303716 = function(param){ 
	 $rootScope.design_30271($scope,param); 
} 

$scope.makeDesign_304070 = function(param){ 
	 $rootScope.design_30297($scope,param); 
} 
