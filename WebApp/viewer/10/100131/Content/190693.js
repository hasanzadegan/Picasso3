app = angular.module("APP").controller("Ctrl190693", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303646 = function(param){ 
	 $rootScope.design_30268($scope,param); 
} 

$scope.makeDesign_303896 = function(param){ 
	 $rootScope.design_30285($scope,param); 
} 
