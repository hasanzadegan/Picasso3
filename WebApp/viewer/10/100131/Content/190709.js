app = angular.module("APP").controller("Ctrl190709", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303894 = function(param){ 
	 $rootScope.design_30263($scope,param); 
} 
