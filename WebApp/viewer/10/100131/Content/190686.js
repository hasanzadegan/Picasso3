app = angular.module("APP").controller("Ctrl190686", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303537 = function(param){ 
	 $rootScope.design_30257($scope,param); 
} 

$scope.makeDesign_303575 = function(param){ 
	 $rootScope.design_30258($scope,param); 
} 

$scope.makeDesign_303539 = function(param){ 
	 $rootScope.design_30262($scope,param); 
} 

$scope.makeDesign_303540 = function(param){ 
	 $rootScope.design_30261($scope,param); 
} 
