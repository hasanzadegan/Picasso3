app = angular.module("APP").controller("Ctrl190718", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast){
...
$scope.makeDesign_304080 = function(param){ 
	 $rootScope.design_30302($scope,param); 
} 
