app = angular.module("APP").controller("Ctrl190688", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303860 = function(param){ 
	 $rootScope.design_30295($scope,param); 
} 
