app = angular.module("APP").controller("Ctrl190675", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293455 = function(param){ 
	 $rootScope.design_30251($scope,param); 
} 

$scope.makeDesign_303931 = function(param){ 
