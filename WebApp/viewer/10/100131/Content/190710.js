app = angular.module("APP").controller("Ctrl190710", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303905 = function(param){ 
	 $rootScope.design_30286($scope,param); 
} 

$scope.makeDesign_303916 = function(param){ 
	 $rootScope.design_30287($scope,param); 
} 
