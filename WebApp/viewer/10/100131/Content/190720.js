app = angular.module("APP").controller("Ctrl190720", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http','$timeout', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http,$timeout){
...
$scope.makeDesign_304093 = function(param){ 
	 $rootScope.design_30305($scope,param); 
} 
