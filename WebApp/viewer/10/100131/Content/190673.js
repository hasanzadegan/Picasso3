app = angular.module("APP").controller("Ctrl190673", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http','$timeout', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http,$timeout){
...
$scope.makeDesign_293422 = function(param){ 
	 $rootScope.design_20247($scope,param); 
} 

$scope.makeDesign_303499 = function(param){ 
	 $rootScope.design_20251($scope,param); 
} 

$scope.makeDesign_303893 = function(param){ 
	 $rootScope.design_30288($scope,param); 
} 
