app = angular.module("APP").controller("Ctrl190716", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_304000 = function(param){ 
	 $rootScope.design_30291($scope,param); 
} 

$scope.makeDesign_304018 = function(param){ 
