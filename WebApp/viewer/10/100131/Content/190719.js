app = angular.module("APP").controller("Ctrl190719", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_304091 = function(param){ 
	 $rootScope.design_30304($scope,param); 
} 
