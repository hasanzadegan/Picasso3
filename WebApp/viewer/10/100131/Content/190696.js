app = angular.module("APP").controller("Ctrl190696", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http','$timeout', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http,$timeout){
...
$scope.makeDesign_303709 = function(param){ 
	 $rootScope.design_30270($scope,param); 
} 

$scope.makeDesign_303930 = function(param){ 
