app = angular.module("APP").controller("Ctrl190690", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303686 = function(param){ 
	 $rootScope.design_30267($scope,param); 
} 

$scope.makeDesign_303752 = function(param){ 
