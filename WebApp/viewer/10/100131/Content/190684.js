app = angular.module("APP").controller("Ctrl190684", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303529 = function(param){ 
	 $rootScope.design_30252($scope,param); 
} 

$scope.makeDesign_304067 = function(param){ 
	 $rootScope.design_30296($scope,param); 
} 
