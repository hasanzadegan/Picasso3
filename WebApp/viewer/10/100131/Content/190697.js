app = angular.module("APP").controller("Ctrl190697", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_303720 = function(param){ 
	 $rootScope.design_30272($scope,param); 
} 

$scope.makeDesign_303738 = function(param){ 
	 $rootScope.design_30261($scope,param); 
} 

$scope.makeDesign_303737 = function(param){ 
	 $rootScope.design_30303($scope,param); 
} 
