...
app.controller("globalCTRL", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$timeout', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$timeout){
	...
	if (window.location.href.includes("<<<TestSite>>>")) {
        ...
        $rootScope.BaseUrls = "http://school.autotaxi.ir/DesktopModules/SchoolService.Controllers/api/".split(";");
    }
