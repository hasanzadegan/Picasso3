app = angular.module("APP").controller("Ctrl190616", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293053 = function(param){ 
	 $rootScope.design_20203($scope,param); 
} 
