app = angular.module("APP").controller("Ctrl190617", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293055 = function(param){ 
	 $rootScope.design_20204($scope,param); 
} 

$scope.makeDesign_293128 = function(param){ 
	 $rootScope.design_20214($scope,param); 
} 
