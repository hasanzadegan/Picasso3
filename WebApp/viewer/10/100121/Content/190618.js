app = angular.module("APP").controller("Ctrl190618", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293062 = function(param){ 
	 $rootScope.design_20205($scope,param); 
} 
