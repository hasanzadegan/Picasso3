app = angular.module("APP").controller("Ctrl190620", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_293093 = function(param){ 
	 $rootScope.design_20210($scope,param); 
} 

$scope.makeDesign_293126 = function(param){ 
	 $rootScope.design_20212($scope,param); 
} 

$scope.makeDesign_293125 = function(param){ 
	 $rootScope.design_20213($scope,param); 
} 
