...
'$rootScope','$scope', '$http','$q','$filter','$translate', function ($rootScope,$scope, $http,$q, $filter,$translate){
	...
	$rootScope.BaseUrls="http://172.16.201.42:7001/ehealth-ws-1.2/rest/api/v1".split(";");
	$rootScope.contents=[];
	...
	$rootScope.part1 = {};
	$rootScope.part1.pageId = "180355";
	$rootScope.part1.pageContentId = "190524";
...
$rootScope.getDynamicData = function(variable,staticData,baseUrlId,url,catalog,filter){
	data={};
	data.item = catalog;
	data.filter = filter;
	if(baseUrlId!="")
