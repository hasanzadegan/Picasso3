app = angular.module("APP").controller("Ctrl190590", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_292926 = function(param){ 
	 $rootScope.design_20180($scope,param); 
} 
