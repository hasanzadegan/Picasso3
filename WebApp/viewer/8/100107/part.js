	...
	function ($rootScope,$scope){
		$rootScope.$watch("__signOutTime",function (newValue, oldValue) {
			try{
				...
				{
					var partStorageStr = localStorage.getItem("__localStorage.__partsStorage1");
		...
		$scope.navigateULR = function(pageId,pageContentId){
			...
			localStorage.setItem("__localStorage.__partsStorage1", JSON.stringify($rootScope.partsStorage)); 
		}
